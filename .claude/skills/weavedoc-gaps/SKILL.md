...
3. **enumeration** — a stated count exceeds actual coverage: "6곡" but 5 live lyric truths, "5인조" but 3 member profiles, "4 Phase" but 3 described. Count over **live** truths only (see resolution-aware rule).
