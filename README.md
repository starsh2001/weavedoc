...
- `upgrade [--check|--dry-run|--apply]` — the migration surface, between migrators: the v1→v2 hop retired with the v3 flip (a v1 mine is routed to the pinned bridge runtime v0.5.21), and the v2→v3 migrator lands in slice 2 of the approved plan — until then this refuses rather than guessing. See [UPGRADING.md](UPGRADING.md).
