...
- (There is no migration command. The v2→v3 migrator retired in 0.6.15, the way the v1 path did before it: **pinned to the last bundle that carried it** — v0.6.14, commit `924e97e`. A v2 mine is refused toward that checkout by the version gate; a v1 mine toward the v0.5.21 bridge first. See [UPGRADING.md](UPGRADING.md).)
