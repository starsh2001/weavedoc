...
// intake (and the retired migrator's transaction did too) — acquires THIS lock through THIS
// module; a second spelling of the protocol would be the two-writers drift class in its locking
// clothes.
